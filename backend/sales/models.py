...
class PaymentMethod(models.Model):
    ...
    payment_method_info = models.CharField(
...
class SalesDetail(models.Model):
    ...
    sales_detail_prod_price = models.DecimalField(
        max_digits=19, decimal_places=2)
    sales_detail_tax = models.DecimalField(max_digits=19, decimal_places=2)
    sales_detail_discount = models.DecimalField(
        max_digits=19, decimal_places=2, blank=True, null=True)
    sales_detail_quantity = models.IntegerField()
    sales_detail_subtotal = models.DecimalField(
        max_digits=19, decimal_places=2)
    product_s = models.ForeignKey(Product, models.DO_NOTHING)
    sales = models.ForeignKey(Sales, models.DO_NOTHING)
    service_detail = models.ForeignKey(
        'service.ServiceDetail', models.DO_NOTHING, blank=True, null=True)
