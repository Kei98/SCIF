"""
Django settings for SCIF_home project.
...
SECRET_KEY = 'django-insecure-okox3#p!sd(psq$ns!=lxrrs2ug9i_bnsvpp23zptpb7%a%2mk'
...
WSGI_APPLICATION = 'SCIF_home.wsgi.application'
...
DATABASES = {
	'default': {
		...
		'NAME': 'automatizacionsvonlineshop',
		'USER': 'root',
		'PASSWORD': 'GitKei98*',
		'HOST':'localhost',
		'PORT':'3306',
